...
kernels={}
for name,fn in [('project_control',gc.project_local_control),('reachable_step',gc._reachable_step),('path_limits',gc._local_path_limits),('stage_diagnostics',gc.stage_diagnostics)]:
