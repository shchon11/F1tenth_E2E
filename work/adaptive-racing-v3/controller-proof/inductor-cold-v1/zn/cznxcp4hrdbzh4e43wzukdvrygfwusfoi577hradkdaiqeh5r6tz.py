...
#   %arg2_1 : Tensor "f32[1, 2][2, 1]cuda:0" = PlaceHolder[target=arg2_1]
...
#   %select_3 : Tensor "f32[1][2]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%arg2_1, 1, 0), kwargs = {})
...
#   %select_6 : Tensor "f32[1][2]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%arg2_1, 1, 1), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        assert_size_stride(arg2_1, (1, 2), (2, 1))
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg2_1 = rand_strided((1, 2), (2, 1), device='cuda:0', dtype=torch.float32)
