...
# `track_contours` / `_runs_off_edge` moved to `viewer/contours.py` (torch-free, so the console
# process can contour a scene without this module's torch import); re-exported here unchanged.
from .contours import _runs_off_edge, track_contours          # noqa: E402,F401
