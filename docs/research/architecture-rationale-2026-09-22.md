...
| # | 비교 | 무엇을 가리나 | 비용 | 우선 |
|---|---|---|---|---|
| E0 | s912 체크포인트(u128, u768, 최종) 대 s911 | 이어서 학습한 것이 도움이 됐나 | 평가 30분 | **완료 — 아래 4.3** |
...
### 4.3 E0 결과: s912는 s911을 넘지 못했다 (2026-09-22)

같은 평가(`scripts/eval_ckpts.sh`, 6개 조건, 시드 77). 장애물 충돌은 장애물이 있는 5개 조건을 합산했다.

| 체크포인트 | 장애물 충돌/km | 랩(장애물) s | 랩(빈 트랙) s | 추월/분 | 차량 접촉/분 |
|---|---:|---:|---:|---:|---:|
| s906 | 7.25 (196/27.0 km) | 8.11 | 7.87 | 1.06 | 22.4 |
| **s911 최종** | **3.75** (102/27.2 km) | **8.02** | **7.69** | **1.28** | 17.0 |
| s912 u128 | 6.02 (163/27.1 km) | 7.93 | 7.59 | 1.27 | 18.1 |
| s912 u768 | 5.16 (130/25.2 km) | 8.16 | 7.77 | 1.20 | 21.5 |
| s912 최종 | 3.73 (98/26.2 km) | 8.41 | 7.81 | 1.20 | **12.9** |

s912는 동시 리셋만 고친 s911의 연장이다. 최종 체크포인트는 장애물 충돌이 s911과 같고,
차량 접촉을 24% 줄인 대신 장애물이 있는 랩에서 0.39 s 느리다. 중간 체크포인트는 빠르지만 더
부딪힌다. 개선이 아니라 속도와 안전 사이의 이동이다. 3장의 "떠돌기"가 평가에서도 보인 셈이고,
다음 한 번은 E5(학습률 감소 + s911에 KL 고정)다.
